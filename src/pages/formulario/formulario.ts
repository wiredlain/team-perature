...
import { IonicPage, NavController, AlertController, Events, Loading, LoadingController } from 'ionic-angular';
import { CuestionarioProvider, Cuestionario, ItemPregunta } from '../../providers/cuestionario/cuestionario';
	...
	public ionViewWillEnter() {
		...
		this.cuestionarioService.getAll().subscribe(
			cuestionarios => {
				...
				console.log(_cuestionario.jsonPreguntas);
